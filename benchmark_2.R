...
metrics = benchmark(data$P_AMM_FOB_BLACK_SEA, xdata, indiff = TRUE, expanding = FALSE, test_start = "2018-12-23", metric = "MAPE", horizon = 40, model_names = model_names)
autoplot(ts(metrics[,1:3,]))

metrics_2 = benchmark(data$P_AMM_FOB_BLACK_SEA, xdata, indiff = TRUE, expanding = TRUE, test_start = "2018-12-23", metric = "MAPE", horizon = 40, model_names = model_names)
autoplot(ts(metrics_2[,,]))
